# ELMAN-OS Foundation Kit v0.4.0 alpha 5
...
timeouts, retries et budgets, registre dynamique, puis adaptateurs OpenAI et
OpenAI-compatible à transport injectable.
...
| Capacité | Statut v0.4.0 alpha 5 |
|---|---|
...
```powershell
Expand-Archive `
  "$env:USERPROFILE\Downloads\ELMAN-OS-Foundation-Kit-v0.4.0-alpha.5.zip" `
  -DestinationPath "$env:USERPROFILE\Desktop"

Set-Location "$env:USERPROFILE\Desktop\elman-os-foundation-kit-v0.4.0-alpha.5"
...
Les prochains lots v0.4 ajoutent le routage multi-fournisseurs, l'exécution
